...
<body>
  ...
  <section id="patient" class="patient">
      <div class="container">
        ...
        <div class="row">
          <div class="col">
            <a href="addpatient.php?from=admin" class="btn btn-primary rounded-pill">Add Patient</a>
            <a href="addconsultation.php?from=admin" class="btn btn-primary rounded-pill">Add Consultation</a>
          </div>
          <div class="col-3">
                ...
                ?>
                  <tr class="align-middle">
                    ...
                    <td class="col-3">
                      ...
                      <a href="delete.php?id=<?= $p["id_pasien"]?>" class="btn btn-danger my-1" onclick="return confirm('Are you sure you want to delete it?')">Delete</a>
                    </td>
                </tr>
                <tr>
                  <td>
